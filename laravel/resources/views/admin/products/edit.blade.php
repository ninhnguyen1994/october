    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <form method="POST" action="{{ route('admin.products.edit.post',$products->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group @if ($errors->has('category_id')) has-error @endif ">
                            ...
                            <select class="form-control select2" name="category_id" style="width:100%">
                                @foreach ($categorys as $item)
                                    <option value="{{ $item->id }}" @if ($item->id == old('category_id',$products->category_id)) selected @endif>{{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group @if ($errors->has('number')) has-error @endif ">
                            ...
                            <input type="text" class="form-control" name="number" value="{{ old('number',$products->number) }}"
                        ...
                        <div class="form-group @if ($errors->has('status_hight_light')) has-error @endif ">
                            ...
                            <input type="checkbox" name="status_hight_light" value="1" @if (old('status_hight_light',$products->status_hight_light) == 1) checked @endif>
                        ...
                        <div class="form-group @if ($errors->has('img')) has-error @endif ">
                            ...
                            <div id="preview">
                                @foreach ($products->images as $image)
                                    <img src="{{ asset('uploads/products/'.$image->name) }}" height="100" alt="">
                                @endforeach
                            </div>
                        </div>
