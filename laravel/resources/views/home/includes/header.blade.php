                    ...
                    <div class="slicknav_menu"><a href="#" aria-haspopup="true" role="button" tabindex="0"
                        ...
                        <ul class="slicknav_nav slicknav_hidden" aria-hidden="true" role="menu" style="display: none;">
                            ...
                            <li class="slicknav_collapsed slicknav_parent"><a href="#" role="menuitem"
                                    ...
                                    style="outline: none;"><a href="#" tabindex="-1">Shop<i
                            ...
                            <li class="slicknav_collapsed slicknav_parent"><a href="#" role="menuitem"
                                    aria-haspopup="true" tabindex="-1" class="slicknav_item slicknav_row"
                                    style="outline: none;"><a href="#" tabindex="-1">Blog<i
                                            class="ti-angle-down"></i></a>
                                    <span class="slicknav_arrow">►</span></a>
                                <ul class="dropdown slicknav_hidden" role="menu" aria-hidden="true"
                                    style="display: none;">
                                    <li><a href="blog-single-sidebar.html" role="menuitem" tabindex="-1">Blog Single
                                            Sidebar</a></li>
                                </ul>
                            </li>
                ...
                <div class="search-bar-top">
                    <div class="search-bar">
                        ...
                        <div class="nice-select" tabindex="0"><span class="current">All Category</span>
                            <ul class="list">
                                <li data-value="All Category" class="option selected">All Category</li>
                                ...
                                <div class="nav-inner">
                                    <ul class="nav main-menu menu navbar-nav">
                                        @foreach ($categorys as $category)
                                            {{-- @if (Request::fulUrl() == route('home.category.get', [$category->slug])) active @endif --}}
                                            <li class="">
                                                @if ($category->childrenRecursive()->count())
                                                    <a href="">{{ $category->name }} <i class="ti-angle-down"></i>
                                                    </a>
                                                    <ul class="dropdown">
